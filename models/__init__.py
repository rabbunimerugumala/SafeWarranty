...
class WarrantyCard(db.Model):
    ...
    # Add user_id to associate warranties with users
    user_id = db.Column(db.Integer, db.ForeignKey('user.id'))
    user = db.relationship('User', backref='user_warranties')  # Changed 'warranties' to 'user_warranties'

    def __repr__(self):
        return f"<WarrantyCard {self.product_name}>"
...
class User(UserMixin, db.Model):
    ...
    # Relationship to warranties: A user can have many warranties
